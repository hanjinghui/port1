 ...
 * @since 28.04.2003
 */
public class CustomMutiDateEditor extends PropertyEditorSupport {
     ...
     */
    public CustomMutiDateEditor(DateFormat[] dateFormats, boolean allowEmpty) {
     ...
     */
    public CustomMutiDateEditor(DateFormat[] dateFormats, boolean allowEmpty, int exactDateLength) {
        this.dateFormats = dateFormats;
        this.allowEmpty = allowEmpty;
    ...
    public String getAsText() {
        ...
        return (value != null ? this.dateFormats[0].format(value) : "");
    }
    ...
    public void setAsText(String text) throws IllegalArgumentException {
        if (this.allowEmpty && !StringUtils.hasText(text)) {
            ...
            try {
                setValue(this.dateFormats[0].parse(text));
            } catch (ParseException ex) {
                try {
                    setValue(this.dateFormats[1].parse(text));
