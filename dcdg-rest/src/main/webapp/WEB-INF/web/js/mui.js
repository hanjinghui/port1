...
(function ($, window) {
    ...
    Transparent.prototype.handleScroll = function (e) {
        ...
        if (document.getElementById('aui-icon')) {
            if (opacity > this._A) {
                document.getElementById('aui-icon').style.color = "black";
                document.getElementById('aui-icon').style.background = "transparent";
                document.getElementById('hide').style.display = 'block';
            } else {
                document.getElementById('aui-icon').style.color = "white";
                document.getElementById('aui-icon').style.background = "black";
