...
public class AliPaymentConfig {
    ...
    @Value("${PUBLIC_KEY}")
    private String public_key;// 支付宝的公钥  @Value("${PUBLIC_KEY}")
    @Value("${PUBLIC_KEY2}")
    private String public_key2;// 支付宝的公钥

    public String getPublic_key2() {
        return public_key2;
    }

    public void setPublic_key2(String public_key2) {
